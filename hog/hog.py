...
def boar_brawl(player_score, opponent_score):
    ...
    opponent_score_ones=opponent_score//10%10
    sub_score=3*abs(player_score_ones-opponent_score_ones)
    if sub_score>1:
        return sub_score
    return 1
    # END PROBLEM 2
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    max_num,num=0,0
    for i in range(1,11):
        num=make_averaged(roll_dice,times_called)(i,dice)
        if num>max_num:
            max_num=num
            index=i
    return index
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    player_score=sus_update(0,score,opponent_score)
    if (player_score-score)>=threshold:
        return 0
    return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
        This is strategy returns 0 dice whenever it can bring more score than 6 dice
    """
    # BEGIN PROBLEM 12
